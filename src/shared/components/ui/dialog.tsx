...
// Заменил стандартный DialogContent на следующий из-за бага с использованием overflow-auto внутри модального окна,
// что вызывало blur на контенте в Google Chrome
